...
| `experimental.chat.system.transform`  | Appends a fresh Context Pack to the system prompt, with explicit affordances for the 5 topology MCP tools (callers / callees / importers / dependencies / definitions). |
