 ...
 * stop hook.
 *
 * Records the conversation as an episode (verdict="idle") with the
 * first captured user message + `git diff` as the patch.
 *
 * Returns an empty object — no follow-up message.
 */
